...
<body>
    ...
    <div class="--container w-full flex justify-center mt-4">
        <form class="form" method="POST"
            action="{{ route('keuangan.update-penghasilan-post', ['id_penghasilan' => $data_update->id, 'id_user' => Crypt::encrypt(session('id_user'))]) }}">
            @csrf
            @method('PUT')
            <p class="title">Update Data</p>
            <p class="message">Update data penghasilan yang mungkin kurang cocok!</p>
            <label>
