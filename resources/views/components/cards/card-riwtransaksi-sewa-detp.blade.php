<div class="_transaksi-sewa flex flex-col gap-4 w-full bg-white h-[500px] max-h-[500px]">
    <div class="_judul-filter flex justify-between items-center">
        <div class="_judul">
            <p class="text-[18px] font-medium">Riwayat Transaksi Sewa</p>
            <p class="text-[14px]">Transaksi sewa barang customer sebelumnya yang telah dilakukan.</p>
        </div>
        {{-- todo filter --}}
        <div class="_filter">
