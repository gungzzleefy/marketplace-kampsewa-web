    ...
    <div
        ...
        <div
            ...
            <div class="_body w-full mt-4 flex-grow p-2 overflow-y-auto">
                <form method="POST" id="form-tambah-pemasukan" action="{{ route('penghasilan.tambah-penghasilan-dev', ['id_user' => Crypt::encrypt(session('id_user'))]) }}"
                    class="w-full flex flex-col gap-2">
                    @csrf
                    <input type="hidden" name="id_user" value="{{ session('id_user') }}">
                    <div class="_input w-full">
                        <label for="fullname">Sumber</label>
                        <input value="Service" readonly class="border w-full border-solid rounded-[10px] text-[14px] p-2"
